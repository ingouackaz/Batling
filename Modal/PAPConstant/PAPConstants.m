...
NSString *const kPAPActivityPhotoKey       = @"batJoke";
...
NSString *const kPAPPhotoAttributesIsDislikedByCurrentUserKey = @"isDislikedByCurrentUser";

NSString *const kPAPPhotoAttributesLikeCountKey            = @"likeCount";
NSString *const kPAPPhotoAttributesLikersKey               = @"likers";

NSString *const kPAPPhotoAttributesDislikeCountKey            = @"dislikeCount";
NSString *const kPAPPhotoAttributesDislikersKey               = @"dislikers";
