...
- (void)setAttributesForPhoto:(PFObject *)photo   likers:(NSArray *)likers  dislikers:(NSArray *)dislikers likedByCurrentUser:(BOOL)likedByCurrentUser dislikedByCurrentUser:(BOOL)dislikedByCurrentUser{
    NSDictionary *attributes = [NSDictionary dictionaryWithObjectsAndKeys:
                                ...
                                [NSNumber numberWithBool:dislikedByCurrentUser],kPAPPhotoAttributesIsDislikedByCurrentUserKey,
                                @([likers count]),kPAPPhotoAttributesLikeCountKey,
                                likers,kPAPPhotoAttributesLikersKey,
                                [NSNumber numberWithBool:dislikedByCurrentUser],kPAPPhotoAttributesIsDislikedByCurrentUserKey,
                                @([dislikers count]),kPAPPhotoAttributesDislikeCountKey,
                                dislikers,kPAPPhotoAttributesDislikersKey,nil];

    NSLog(@" object id %@ attr %@",photo.objectId,attributes);
...
- (void)setAttributesForPhoto:(PFObject *)photo likers:(NSArray *)likers commenters:(NSArray *)commenters dislikedByCurrentUser:(BOOL)likedByCurrentUser {
    NSDictionary *attributes = [NSDictionary dictionaryWithObjectsAndKeys:
                                [NSNumber numberWithBool:likedByCurrentUser],kPAPPhotoAttributesIsDislikedByCurrentUserKey,
                                @([likers count]),kPAPPhotoAttributesDislikeCountKey,
                                likers,kPAPPhotoAttributesDislikersKey,
                                nil];
    
    NSLog(@"set dislikes attributes");
    [self setAttributes:attributes forPhoto:photo];
}
...
- (NSNumber *)dislikeCountForPhoto:(PFObject *)photo {
    ...
    if (attributes) {
        ...
        return [attributes objectForKey:kPAPPhotoAttributesDislikeCountKey];
    }
...
- (NSArray *)dislikersForPhoto:(PFObject *)photo {
    NSDictionary *attributes = [self attributesForPhoto:photo];
    if (attributes) {
        return [attributes objectForKey:kPAPPhotoAttributesDislikersKey];
    }
...
- (void)setPhotoIsDislikedByCurrentUser:(PFObject *)photo liked:(BOOL)liked {
    NSMutableDictionary *attributes = [NSMutableDictionary dictionaryWithDictionary:[self attributesForPhoto:photo]];
    [attributes setObject:[NSNumber numberWithBool:liked] forKey:kPAPPhotoAttributesIsDislikedByCurrentUserKey];
    [self setAttributes:attributes forPhoto:photo];
}
...
- (BOOL)isPhotoDislikedByCurrentUser:(PFObject *)photo{
    NSDictionary *attributes = [self attributesForPhoto:photo];
    if (attributes) {
        return [[attributes objectForKey:kPAPPhotoAttributesIsDislikedByCurrentUserKey] boolValue];
    }
...
- (void)incrementDislikerCountForPhoto:(PFObject *)photo {
    ...
    NSNumber *likerCount = [NSNumber numberWithInt:[[self dislikeCountForPhoto:photo] intValue] + 1];
    
    NSMutableDictionary *attributes = [NSMutableDictionary dictionaryWithDictionary:[self attributesForPhoto:photo]];
    
    [attributes setObject:likerCount forKey:kPAPPhotoAttributesDislikeCountKey];
