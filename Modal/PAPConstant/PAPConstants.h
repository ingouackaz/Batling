...
extern NSString *const kPAPPhotoAttributesIsDislikedByCurrentUserKey;
extern NSString *const kPAPPhotoAttributesDislikeCountKey;
extern NSString *const kPAPPhotoAttributesDislikersKey;
